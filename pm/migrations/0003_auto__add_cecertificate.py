...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CECertificate'
        db.create_table(u'pm_cecertificate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pm.Project'])),
            ('date', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal(u'pm', ['CECertificate'])


    def backwards(self, orm):
        # Deleting model 'CECertificate'
        db.delete_table(u'pm_cecertificate')
