...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MachineComment.author'
        db.add_column(u'pm_machinecomment', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MachineComment.author'
        db.delete_column(u'pm_machinecomment', 'author_id')
