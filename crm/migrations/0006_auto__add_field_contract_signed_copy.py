...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contract.signed_copy'
        db.add_column(u'crm_contract', 'signed_copy',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contract.signed_copy'
        db.delete_column(u'crm_contract', 'signed_copy')
