...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'crm_contractitem', (
            ...
            ('price', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2, blank=True)),
        ))
        db.send_create_signal(u'crm', ['ContractItem'])
        ...
        db.create_table(u'crm_contract', (
            ...
            ('delivery_time', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
            ('delivery_method', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True)),
            ('conditions', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
            ...
            ('vat', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2, blank=True)),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'crm_contractitem')
    ...
    models = {
        ...
        u'crm.contract': {
            ...
            'vat': ('django.db.models.fields.DecimalField', [], {'max_digits': '4', 'decimal_places': '2', 'blank': 'True'})
        },
        u'crm.contractitem': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'price': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
