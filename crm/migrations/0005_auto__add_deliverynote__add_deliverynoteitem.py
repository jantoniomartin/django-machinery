...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'crm_deliverynote', (
        ...
        db.send_create_signal(u'crm', ['DeliveryNote'])

        # Adding model 'DeliveryNoteItem'
        db.create_table(u'crm_deliverynoteitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('note', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.DeliveryNote'])),
            ('quantity', self.gf('django.db.models.fields.PositiveIntegerField')(default=1)),
            ('description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'crm', ['DeliveryNoteItem'])


    def backwards(self, orm):
        # Deleting model 'DeliveryNote'
        db.delete_table(u'crm_deliverynote')

        # Deleting model 'DeliveryNoteItem'
        db.delete_table(u'crm_deliverynoteitem')
