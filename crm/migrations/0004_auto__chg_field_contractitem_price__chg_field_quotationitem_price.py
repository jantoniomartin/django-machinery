...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ContractItem.price'
        db.alter_column(u'crm_contractitem', 'price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2))

        # Changing field 'QuotationItem.price'
        db.alter_column(u'crm_quotationitem', 'price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'ContractItem.price'
        db.alter_column(u'crm_contractitem', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2))

        # Changing field 'QuotationItem.price'
        db.alter_column(u'crm_quotationitem', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2))
